...
const SellerBanner = () => {
  return (
     <Container className='seller-banner-container mt-5 bg-light p-5' fluid>
       <Row className='seller-banner-row w-100'>
           ...
           <Col>
            ...
            <h5 className='seller-banner-subtitle'>What our sellers are saying: </h5>
                ...
                <br />
                <Button variant='dark' className='seller-banner-button'>Get Started</Button>
            </Col> 
        </Row>
        <br />
      </Container>
